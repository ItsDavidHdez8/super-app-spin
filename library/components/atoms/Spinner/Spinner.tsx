...
const LottieSpinnerDefault = require('../../../../src/assets/SpinnerLottie/spinner-default.json');
const LottieSpinnerInverse = require('../../../../src/assets/SpinnerLottie/spinner-inverse.json');
